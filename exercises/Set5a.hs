...
totalPrice (MkShoppingEntry _ price n) = price * fromIntegral n
...
buyOneMore (MkShoppingEntry item price n) = MkShoppingEntry item price (n + 1)
...
rgb (Invert a) = zipWith (-) [1, 1, 1] (rgb a)
